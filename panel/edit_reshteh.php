...
<body>
   ...
   <section id="container">
	...
	if($_POST["title"]!="" && $_POST["status"]!=""){
			...
			$sql = "UPDATE `$tbl_reshteh` SET `name`=:title,`status`=:status WHERE `id`=:id";
			...
			if($result->execute()){
				$URL = "reshteh.php?edit_proccess=success";
				...
				?>
                            ...
                            <div class="col-lg-12">
                                <section class="panel">
									...
									$s="SELECT * FROM `$tbl_reshteh` WHERE `id`=:id";
									...
									?>
										   <label class="col-sm-2 control-label">ویرایش نام رشته:</label>
                                        <div class="col-sm-10">
										<input type="hidden" name="getid" value="<?=$rows['id'];?>">
                                            <input name="title" type="text" class="form-control" value="<?=$rows['name'];?>">
                                            <span class="help-block">نام رشته مورد نظر را وارد نمایید </span>
                                        </div>
										
										  
										
											        <div class="form-group">
                                        <label class="control-label col-lg-2" for="inputSuccess">وضعیت رشته</label>
                                        <div class="col-lg-10">
                                           ...
                                           <select class="form-control input-sm m-bot15" name="status">
                                             ...
                                             <option value="0" <?php if($rows['status']=="0"){echo "selected";}?>>غیرفعال</option>
												...
												<button name="edit" type="submit" class="btn btn-success btn-lg btn-block">ویرایش رشته</button>
                                            </form>
