...
<!--header start-->
      <header class="header white-bg">
            <div class="sidebar-toggle-box">
                <div data-original-title="جمع کردن منو" data-placement="left" class="icon-reorder tooltips"></div>
            </div>
            <!--logo start-->
...
$asabani="SELECT * FROM `$tbl_manager` WHERE `id`=:id";
$resulttam=$connect->prepare($asabani);
$resulttam->bindParam(":id",$admin_id);
$resulttam->execute();
while($khoshhal=$resulttam->fetch(PDO::FETCH_ASSOC)){

?>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img width="45" hight="45" alt="" src="../<?=$khoshhal['pic'];?>">
<span class="username">
         <?php
                   echo $khoshhal['name']."&nbsp;".$khoshhal['lname'];                                   
