...
<body>
   ...
   <section id="container">
	...
	if($_POST["title"]!="" && $_POST["status"]!=""){
			...
			$sql = "UPDATE `$tbl_group` SET `title`=:title,`des`=:des,`status`=:status WHERE `id`=:id";
			...
			if($result->execute()){
				$URL = "groups.php?edit_proccess=success";
				...
				?>
                            ...
                            <div class="col-lg-12">
                                <section class="panel">
									...
									/******inja ham variable $tbl_menu kar nakard********/
									$s="SELECT * FROM `$tbl_group` WHERE `id`=:id";
									...
									?>
										   <label class="col-sm-2 control-label">ویرایش نام گروه:</label>
                                        <div class="col-sm-10">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <span class="help-block">توضیحات گروه های کاربری را وارد کنید</span>
                                        </div>
										
											        <div class="form-group">
                                        <label class="control-label col-lg-2" for="inputSuccess"> وضعیت گروه</label>
                                        <div class="col-lg-10">
                                           ...
                                           <select class="form-control input-sm m-bot15" name="status">
                                             ...
                                             <option value="0" <?php if($rows['status']=="0"){echo "selected";}?>>غیرفعال</option>
												...
												<button name="edit" type="submit" class="btn btn-success btn-lg btn-block">ویرایش گروه</button>
                                            </form>
