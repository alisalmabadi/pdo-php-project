...
<head>
    ...
    <title>افزودن وضعیت تحصیلی</title>
...
if(isset($_POST['send'])){
	if($_POST["title"]!="" && $_POST['status']!=""){
				...
				$sql = "INSERT INTO `$tbl_tahsil`(`id`,`title`,`des`,`status`) VALUES(NULL,:title,:des,:status)";
				$result = $connect->prepare($sql);
				$result->bindParam(":title",$title);
				$result->bindParam(":des",$des);
				$result->bindParam(":status",$status);
				if($result->execute()){
					$success = "وضعیت تحصیلی مورد نظر با موفقیت ثبت گردید";
				}else{
					$wrong = "خطا در ثبت وضعیت تحصیلی";
				}
...
if(isset($_GET['del_id'])){
	...
	$sqlam="DELETE FROM `$tbl_tahsil` WHERE `id`=:id"; 
                                ...
                                <section class="panel">
									...
									<form action="" class="form-horizontal" method="post">
                                        <div class="form">
										   ...
										   <label class="col-sm-2 control-label">نام وضعیت تحصیلی مورد نظر</label>
                                        <div class="col-sm-10">
										  ...
										  <label class="col-sm-2 control-label">توضیحات گروه گروه</label>
                                        <div class="col-sm-10">
                                            <input name="des" type="text" class="form-control">
                                            <span class="help-block">توضیحات وضعیت تحصیلی را وارد نمایید </span>
                                        </div>
                        ...
                        <section class="panel">
                            ...
                            <table class="table table-striped border-top" id="sample_1">
								...
								<center>
                                    ...
                                    <tr>
                                        ...
                                        <th class="hidden-phone">نام وضعیت تحصیلی</th>
                                     <th class="hidden-phone">توضیحات وضعیت تحصیلی</th>
                                ...
                                <tbody>
								<?php
								$s="SELECT * FROM `$tbl_tahsil` ORDER BY `id` DESC";
							...
							?>
								...
								<a  href="?del_id=<?php echo $idha;?>"> <button type="button" class="btn btn-round btn-danger"><i class="icon-remove-sign"></i>حذف</button></a>
                           	    <a href="edit_educate.php?edit_id=<?php echo $idha;?>"> <button type="button" class="btn btn-round btn-warning"><i class="icon-pencil"></i>ویرایش</button></a>
