...
<head>
    ...
    <title>افزودن رشته تحصیلی</title>
...
if(isset($_POST['send'])){
	if($_POST["title"]!="" && $_POST['status']!=""){
				...
				$sql = "INSERT INTO `$tbl_reshteh`(`id`,`name`,`status`) VALUES(NULL,:title,:status)";
				$result = $connect->prepare($sql);
				$result->bindParam(":title",$title);
				$result->bindParam(":status",$status);
				if($result->execute()){
					$success = "رشته مورد نظر با موفقیت افزوده شد.";
				}else{
					$wrong = "خطا در ثبت رشته";
				}
...
if(isset($_GET['del_id'])){
	...
	$sqlam="DELETE FROM `$tbl_reshteh` WHERE `id`=:id"; 
                                   ...
                                   افزودن رشته تحصیلی به سامانه
									...
									<form action="" class="form-horizontal" method="post">
                                        <div class="form">
										   ...
										   <label class="col-sm-2 control-label">نام رشته</label>
                                        <div class="col-sm-10">
                                            <input name="title" type="text" class="form-control">
                                            <span class="help-block">نام رشته مورد نظر را وارد کنید</span>
                                        </div>
                        ...
                        <section class="panel">
                            ...
                            <table class="table table-striped border-top" id="sample_1">
								...
								<center>
                                    ...
                                    <tr>
                                        ...
                                        <th class="hidden-phone">نام رشته</th>
								...
								$s="SELECT * FROM `$tbl_reshteh` ORDER BY `id` DESC";
							...
							?>
								...
								<a  href="?del_id=<?php echo $idha;?>"> <button type="button" class="btn btn-round btn-danger"><i class="icon-remove-sign"></i>حذف</button></a>
                           	    <a href="edit_reshteh.php?edit_id=<?php echo $idha;?>"> <button type="button" class="btn btn-round btn-warning"><i class="icon-pencil"></i>ویرایش</button></a>
