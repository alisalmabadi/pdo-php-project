...
if(isset($_POST['send'])){
	if($_POST["title"]!="" && $_POST['status']!="" && $_POST['group']){
				...
				$sql = "INSERT INTO `$tbl_semat`(`id`,`title`,`group_id`,`des`,`status`) VALUES(NULL,:title,:group_id,:des,:status)";
				...
				if($result->execute()){
					$success = "سمت مورد نظر با موفقیت ثبت گردید";
				}else{
					$wrong = "خطا در  ثبت سمت";
				}
...
if(isset($_GET['del_id'])){
	...
	$sqlam="DELETE FROM `$tbl_semat` WHERE `id`=:id"; 
                                ...
                                <section class="panel">
									...
									<form action="" class="form-horizontal" method="post">
                                        <div class="form">
										   ...
										   <label class="col-sm-2 control-label">نام سمت</label>
                                        <div class="col-sm-10">
                                        ...
                                        <div class="col-lg-10">
                                          ...
                                          <select style="font-size: 10px; color: darkred;" class="form-control input-sm m-bot15" name="group">
											  ...
											  ?>
                                                <option style="font-size: 12px; color: darkred;" value="<?=$rows['id'];?>"><?=$rows['title'];?></option>
                                           <?php
											  }
										  ...
										  <label class="col-sm-2 control-label">توضیحات سمت گروه</label>
                                        <div class="col-sm-10">
                                            <input name="des" type="text" class="form-control">
                                            <span class="help-block">توضیحات سمت مورد نظر را وارد نمایید </span>
                                        </div>
                            ...
                            <table class="table table-striped border-top" id="sample_1">
								...
								<center>
                                    ...
                                    <tr>
                                        ...
                                        <th class="hidden-phone">نام سمت</th>
                                          <th class="hidden-phone">نام گروه</th>
                                                         <th class="hidden-phone"> وضعیت گروه</th>

                     <th class="hidden-phone">توضیحات سمت</th>

                                        <th class="hidden-phone">وضعیت سمت</th>
								...
								$s="SELECT * FROM `$tbl_semat` ORDER BY `id` DESC";
								...
								?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?=$rowsha['title'];?></td>
									                  ...
									                  <?php
									$group_id=$rowsha['group_id'];
									$ss="SELECT * FROM `$tbl_group` WHERE `id`=:id";
									$resultt=$connect->prepare($ss);
									$resultt->bindParam(":id",$group_id);
									$resultt->execute();
									$g_rows=$resultt->fetch(PDO::FETCH_ASSOC);
							...
							?>
								...
								<a  href="?del_id=<?php echo $idha;?>"> <button type="button" class="btn btn-round btn-danger"><i class="icon-remove-sign"></i>حذف</button></a>
                           	    <a href="edit_semat.php?edit_id=<?php echo $idha;?>"> <button type="button" class="btn btn-round btn-warning"><i class="icon-pencil"></i>ویرایش</button></a>
